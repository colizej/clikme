...
urlpatterns = [
    ...
    path('eda-na-zakaz', RedirectView.as_view(url='/vendors/', permanent=True)),
    path('eda-na-zakaz/<slug:slug>/', lambda r, slug: redirect(f'/{slug}/', permanent=True)),
    path('eda-na-zakaz/<slug:slug>', lambda r, slug: redirect(f'/{slug}/', permanent=True)),
    path('blyuda-s-moreproduktami/<slug:slug>/', lambda r, slug: redirect(f'/{slug}/', permanent=True)),
    path('blyuda-s-moreproduktami/<slug:slug>', lambda r, slug: redirect(f'/{slug}/', permanent=True)),
    path('blyuda-s-moreproduktami/', RedirectView.as_view(url='/vendors/', permanent=True)),
